...
you are a visual animation expert and sound effect expert with manim python , From this article please extract every concepts from it and write down how you would explain this using video and animation using less text and interactive visual and proper sound, important note : it's a vertical video , it's 2 minutes long . all the soundeffect is inside the @soundeffect/pop folder
