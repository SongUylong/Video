...
class DockerTikTokExplanation(Scene):
    def construct(self):
        # --- Helpers ---
        ...
        # --- Background ---
        # A nice gradient background for a modern look
        ...
        # Create glowing particles around the center
        particles = VGroup()
        for i in range(12):
            angle = i * (TAU / 12)
        ...
        # Particles rotate and converge while logo grows
        self.play(
            Rotate(particles, angle=PI, about_point=ORIGIN),
            particles.animate.scale(0.3).set_opacity(0),
            docker_logo.animate.scale(20),  # 0.1 * 20 = 2.0 scale
            run_time=1.5,
            rate_func=smooth
        )
        ...
        # Title appears with style - minimal text
        ...
        # Transition - logo shrinks to corner
        self.play(
        ...
        # Use RoundedRectangle for layers to look cleaner
        ...
        # Multiple containers to show isolation
        ...
        # Position containers side by side above docker engine
        ...
        dk_stack_full.move_to(DOWN * 0.5)  # Center vertically with slight downward shift
        ...
        # Pop animation for containers
        self.play(
            GrowFromCenter(container_grp1),
            run_time=0.5
        )
        self.play(
            GrowFromCenter(container_grp2),
            run_time=0.5
        )
        
        # Highlight with a pulse effect
        self.play(
        ...
        # Highlight text with better positioning to avoid overlap
        ...
        # Scenario 1: Failure without Docker
        self.play(
        ...
        # Use a better explosion or just flash
        self.play(
            Transform(app_group, fail_x),
            Flash(server_box.get_center(), color=FAIL_RED, line_length=0.5), # Built-in Flash animation
            run_time=0.4
        )
        self.play(FadeOut(app_group)) # Fade out the X

        # Scenario 2: Success with Docker
        ...
        self.play(FadeIn(code_snippet, shift=UP*0.2))
        self.wait(1.2)
        ...
        # ==============================================
        # SCENE 5: Complete Docker Flow (Fully Aligned)
        # ==============================================
        ...
        # ===== PART 1: Build Phase (centered, vertical) =====
        ...
        # ===== TRANSITION: Clear and show deployment =====
        build_phase = VGroup(
